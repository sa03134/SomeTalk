...
public class Board_Some extends AppCompatActivity {
    SomeBoardAdapter adapter;
    ListView listview;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_board__some);
        ...
        listview = (ListView) findViewById(R.id.some_board_list); // Check
    ...
    public void init() {
        adapter = new SomeBoardAdapter();
        listview.setAdapter(adapter);

        ((MainActivity)MainActivity.context_main).w.getSomeBoard(1);
